...
public class NickNameUtil {
   ...
   private static String[] noun = {
           "一起", "不是", "人们", "今天", "孩子", "心里", "眼睛",
           "学校", "原来", "爷爷", "地方", "过去", "事情", "以后", "可能", "兔子",
           "里面", "才能", "知识", "故事", "多少", "比赛", "冬天", "所有", "样子",
           "成绩", "后来", "以前", "童年", "问题", "日子", "活动", "公园", "作文",
           "旁边", "下午", "自然", "房间", "空气", "笑容", "明天", "风景", "音乐",
           "岁月", "文化", "生气", "机会", "身影", "天气", "空中", "红色", "书包",
           "西瓜", "汽车", "早晨", "道路", "认识", "办法", "精彩",
           "礼物", "星星", "习惯", "树木", "女儿", "友谊", "夜晚", "意义",
           "小猫", "耳朵", "家人", "门口", "班级", "人间", "厨房", "风雨", "影响",
